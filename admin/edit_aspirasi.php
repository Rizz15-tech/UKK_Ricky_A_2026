...
<div class="form-group">
    ...
    <select name="status" class="form-control" required>
        ...
        <option <?php if ($data['status'] == "Menunggu") { echo "selected"; } ?>>
            Menunggu
        </option>

        <option <?php if ($data['status'] == "Proses") { echo "selected"; } ?>>
            Proses
        </option>

        <option <?php if ($data['status'] == "Selesai") { echo "selected"; } ?>>
            Selesai
        </option>

        <option <?php if ($data['status'] == "Tolak") { echo "selected"; } ?>>
            Tolak
        </option>
