...
$tolak    = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM tb_aspirasi WHERE status='Tolak'"));
?>
...
<div class="row mt-4">
  ...
  <div class="col-md-4">
    <div class="card shadow-sm border-0">
      ...
      <div class="card-body">
        <p><span class="badge bg-primary">Biru</span> Aspirasi Baru</p>
        <p><span class="badge bg-warning">Kuning</span> Diproses</p>
        <p><span class="badge bg-success">Hijau</span> Selesai</p>
        <p><span class="badge bg-danger">Merah</span> Tolak</p>
      </div>
    </div>
  </div>
</div>
