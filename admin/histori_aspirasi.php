        ...
        <form method="get" class="row g-2">
            ...
            <div class="col-md-3">
                <select name="status" class="form-control">
                    ...
                    <option value="Tolak" <?= (($_GET['status'] ?? '') == 'Tolak') ? 'selected' : '' ?>>Tolak</option>
                </select>
            </div>
...
<div class="card shadow mb-4">
    <div class="card-body">
        ...
        <div class="mb-3 text-end">
            <a href="?menu=cetak_histori&<?= $nis ?>" target="_blank" class="btn btn-success btn-sm">
                🖨️ Cetak Histori
            </a>
        </div>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            if ($data['status'] == 'Menunggu') {
                                echo "<span class='badge bg-primary text-white'>Menunggu</span>";
                            } elseif ($data['status'] == 'Proses') {
                                echo "<span class='badge bg-warning text-white'>Proses</span>";
                            } elseif ($data['status'] == 'Selesai') {
                                echo "<span class='badge bg-success text-white'>Selesai</span>";
                            } elseif ($data['status'] == 'Tolak') {
                                echo "<span class='badge bg-danger text-white'>Tolak</span>";
                            }
