...
<body>
  ...
  <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
    <a class="navbar-brand" href="?menu">Si-Adu</a>
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="?menu=form_pengaduan">From Pengaduan</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="?menu=data_pengaduan">Data Pengaduan</a>
        </li>
        <li class="nav-item">
